...
-- +goose Down
-- +goose StatementBegin
ALTER TABLE metrics_history ADD COLUMN total_income VARCHAR(16) DEFAULT '0,00';
ALTER TABLE metrics_history ADD COLUMN total_expenses VARCHAR(16) DEFAULT '0,00';
ALTER TABLE metrics_history ADD COLUMN avg_income VARCHAR(16) DEFAULT '0,00';
ALTER TABLE metrics_history ADD COLUMN avg_expenses VARCHAR(16) DEFAULT '0,00';
ALTER TABLE metrics_history ADD COLUMN diff VARCHAR(16) DEFAULT '0,00';
