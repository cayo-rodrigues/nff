...
func (s *ItemsService) ListInvoiceItems(ctx context.Context, invoiceID int, userID int) ([]*models.InvoiceItem, error) {
...
func (s *ItemsService) BulkCreateInvoiceItems(ctx context.Context, items []*models.InvoiceItem, invoiceID int, userID int) error {
	rows := [][]interface{}{}
